      ...
      <div className="px-[15px] w-full">
          ...
          <div className={"mt-[100px] flex flex-wrap justify-center max-[800px]:flex-col max-[800px]:mx-0 " +
              ...
              <div className={"flex mb-[40px] mr-[40px] flex-col min-w-[240px] w-[240px] max-[800px]:mt-[50px] max-[800px]:w-[70%]"}>
                  ...
                  <div className={"flex flex-col w-[90%] mt-[10px] text-left text-[#073B4C]"}>
                  <p>Obtain SPL tokens to use within the Splendor network. You can acquire SPL tokens through various means, such as purchasing them on supported exchanges, receiving them in transactions, or run a node and start mining SDR which you can instantly swap for SPL on <Link className="text-[#1975B5]" href="https://octaocean.com/">otaocean.com</Link></p>
                  </div>
              </div>
